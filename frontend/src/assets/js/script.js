...
I've thought about the past, and I realise I didn't handle things maturely back then. I'm sorry for that. I never meant to make things uncomfortable and awkward for you.
...
document.getElementById('voucher-form').addEventListener('submit', (e) => {
    ...
    alert(`Thanks! If you chose to receive it, the gift coupon will be shared with you soon. Take care 🙂`);
...
console.log(
  "If you’re reading this, it’s me. I just wanted to quietly wish you a very happy birthday. \
Some things are better left unshared, and this is one of them. \
Choose people wisely, take care of yourself, and be happy. 🤍"
);
